...
public val Icons.Outlined.AssignmentReturnedIcon: ImageVector
    get() {
        if (_outlined_assignmentReturned != null) {
            return _outlined_assignmentReturned!!
        }
        _outlined_assignmentReturned = materialIcon(name = "Outlined.AssignmentReturnedIcon") {
            materialPath {
                moveTo(17.0f, 12.0f)
...
private var _outlined_assignmentReturned: ImageVector? = null
